# STATE archive — July 2026

Rolled out of `docs/STATE.md` on 2026-08-31 to keep the working file light
(procedure: housekeeping skill, "STATE.md roll-over"). Entries are verbatim
copies; they are HISTORY, not current state — verify against live systems and
code before acting on anything here. July items that were still open were NOT
archived: they remain in STATE.md (some under Open failures).

## Verified facts (archived)
