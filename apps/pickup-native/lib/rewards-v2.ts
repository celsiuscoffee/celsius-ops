...
export type Voucher = {
  ...
  source_type: "mission" | "mystery" | "birthday" | "referral" | "manual" | "welcome" | "points_redemption" | "campaign" | null;
...
const WALLET_COUNT_SOURCES = ["mystery", "manual", "birthday", "campaign", "welcome"];
