  ...
  try {
    ...
    const { data, error } = await supabaseAdmin
      ...
      .insert({
        ...
        eligible_member_tags: body.eligible_member_tags ?? [],
        ...
        combo_category_ids: body.combo_category_ids ?? [],
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const allowed = [
      ...
      'eligible_member_tags', 'outlet_ids', 'channels',
      'bogo_buy_qty', 'bogo_free_qty', 'free_product_ids', 'free_product_name',
      'combo_product_ids', 'combo_category_ids', 'combo_price', 'override_price',
      'min_order_value',
