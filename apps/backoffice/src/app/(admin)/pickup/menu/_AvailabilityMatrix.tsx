...
/**
 * Per-outlet availability matrix — was the standalone
 * /pickup/menu/availability page. Now embedded as a tab inside
 * /pickup/menu so operators have one place for both catalog setup and
 * per-outlet on/off.
 *
 * Semantics (mirror the customer menu loader):
 ...
 *
 * A "true" override is harmless when global is on, and an admin can't
 * override a globally-off product to on from this matrix (that would
 * mask a real disablement). Flip the global switch on the Catalog tab
 * instead.
 */
