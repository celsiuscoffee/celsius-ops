...
export default function InvoicesPage() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Photo viewer modal */}
      {viewingPhotos && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-2" onClick={() => setViewingPhotos(null)}>
          <div className="relative h-[95vh] w-full max-w-5xl flex flex-col rounded-xl bg-white overflow-hidden" onClick={(e) => e.stopPropagation()}>
