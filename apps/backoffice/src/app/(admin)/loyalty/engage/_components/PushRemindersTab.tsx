...
/**
 * Push reminders tab inside the Engage page. Triggered push
 * notifications driven by the campaign engine in apps/order
 * (lib/push/campaigns.ts + cron/loyalty-pushes). One row per trigger
 * type with rolling 7d / 30d stats and a pause/enable toggle.
 *
 * Lives under engage/_components/ so the route is a single
 * /loyalty/engage page with two tabs (this one + SMS broadcasts).
 * Underscore prefix keeps it out of Next's app-router page scan.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-600 max-w-2xl">
          ...
          Pause a row to stop sending; takes effect on the next cron tick.
        </p>
