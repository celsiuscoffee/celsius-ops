...
export type EmployeeProfile = {
  ...
  // House area(s) this person works (FOH = bar, BOH = kitchen) — overrides the
  // position→area inference used by checklist auto-assign. Multi-valued so a
  // floating shift lead/supervisor can be both. Empty = infer from position.
