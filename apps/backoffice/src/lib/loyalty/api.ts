...
export async function fetchBrands(): Promise<Brand[]> {
  try {
    const res = await fetch("/api/loyalty/brands");
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function fetchOutlets(brandId: string = "brand-celsius"): Promise<Outlet[]> {
  try {
    const res = await fetch(`/api/loyalty/outlets?brand_id=${brandId}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function fetchMembers(
  ...
  try {
    ...
    const res = await fetch(`/api/loyalty/members?${params.toString()}`);
    if (!res.ok) return [];
...
export async function fetchMemberByPhone(
  ...
  try {
    const res = await fetch(`/api/loyalty/members?brand_id=${brandId}&phone=${encodeURIComponent(phone)}`);
...
export async function updateMemberProfile(data: {
  ...
  try {
    const res = await fetch("/api/loyalty/members/profile", {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
export async function fetchRewards(brandId: string = "brand-celsius"): Promise<Reward[]> {
  try {
    const res = await fetch(`/api/loyalty/rewards?brand_id=${brandId}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function fetchTransactions(
  ...
  try {
    const res = await fetch(`/api/loyalty/transactions?member_id=${memberId}&brand_id=${brandId}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function awardPoints(data: {
  ...
  try {
    const res = await fetch("/api/loyalty/points/award", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ brand_id: "brand-celsius", ...data }),
    });
...
export async function fetchCampaigns(brandId: string = "brand-celsius"): Promise<Campaign[]> {
  try {
    const res = await fetch(`/api/loyalty/campaigns?brand_id=${brandId}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function fetchMemberRedemptions(memberId: string): Promise<RedemptionWithDetails[]> {
  try {
    const res = await fetch(`/api/loyalty/redemptions?member_id=${memberId}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function fetchAllRedemptions(brandId: string = "brand-celsius"): Promise<RedemptionWithDetails[]> {
  try {
    const res = await fetch(`/api/loyalty/redemptions?brand_id=${brandId}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function fetchPointsLog(
  ...
  try {
    ...
    const res = await fetch(`/api/loyalty/points-log?${params.toString()}`);
    if (!res.ok) return [];
    return res.json();
  } catch {
    return [];
...
export async function verifyStaffPin(
  ...
  try {
    const res = await fetch("/api/loyalty/staff/verify-pin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "include",
