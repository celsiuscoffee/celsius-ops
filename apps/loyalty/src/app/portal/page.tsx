    ...
    return (
      <div className="portal-fixed flex flex-col bg-neutral-900 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
        ...
        <div className="w-full border-b border-neutral-800 px-5 py-3.5">
          ...
          {isNewMember && (
            <div className="mx-auto mt-3 max-w-md rounded-lg border border-green-700/30 bg-green-900/20 px-4 py-2 text-center">
              <p className="text-sm font-medium text-green-400 font-sans">
                New member — 50 welcome bonus points applied
              </p>
            </div>
          )}
        </div>
