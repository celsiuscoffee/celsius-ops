 ...
 */
export async function sendOTP(phone: string, purpose: 'login' | 'redeem' = 'login') {
 ...
 */
export async function verifyOTP(phone: string, code: string, purpose: 'login' | 'redeem' = 'login'): Promise<boolean> {
